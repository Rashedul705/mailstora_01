...
export default function PortfolioClient({ initialItems, initialStats, initialFeatured, initialTotalPages }: any) {
    const [items, setItems] = useState<any[]>(initialItems || []);
    const [featuredItems, setFeaturedItems] = useState<any[]>(initialFeatured || []);
    const [stats, setStats] = useState<any>(initialStats || { total: 400, emailTemplates: 0, emailSignatures: 0, caseStudies: 0 });
