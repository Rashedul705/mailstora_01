...
export default function BlogClient({ initialPosts, initialTotal, initialTotalPages, initialPopular }: any) {
    ...
    const [popularPosts, setPopularPosts] = useState<any[]>(initialPopular || []);
    ...
    useEffect(() => {
        ...
        const fetchPosts = async () => {
            try {
                ...
                let url = `${API_BASE}/api/blog?page=${page}`;
                if (activeCategory && activeCategory !== "All Posts") url += `&category=${encodeURIComponent(activeCategory)}`;
    ...
    return (
        <div className="blog-container">
            <section className="blog-hero">
                ...
                <p>Practical advice on email marketing, digital strategy, and growing your business — from someone who's done it for 13+ years.</p>
            ...
            <div className="blog-layout">
                ...
                <aside className="blog-sidebar">
                    ...
                    <div className="sidebar-widget widget-cta">
                        ...
                        <Link href="/quote" style={{ display: 'block' }}>
