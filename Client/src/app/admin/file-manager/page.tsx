                            ...
                            <tr key={file.name} style={{ borderBottom: '1px solid #eee' }} className="file-row">
                                <td style={{ padding: '10px 15px' }}>
                                    {file.isDirectory ? (
                                        ...
                                        <a href={`https://mailstora.com/Email_Template/${currentPath ? currentPath + '/' : ''}${file.name}`} target="_blank" style={{ color: '#444', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '14px' }}>
