            ...
            <div className="container hero-container">
                ...
                <div className="hero-content">
                    ...
                    <h1 className="hero-title">
                        Custom{" "}
                        <span className="hero-title-highlight-orange">HTML Email Templates</span>
                        {" "}That Work Perfectly in{" "}
                        <span className="hero-title-highlight">Outlook, Gmail</span>
                        {" "}& 30+ Email Clients
                    </h1>

                    <p className="hero-subtitle">
                        Stop losing engagement due to broken formatting. Get hand-coded,
                        pixel-perfect email templates and professional signatures tested
                        across all major email clients, delivered in 24-48 hours.
                    </p>
                        ...
                        <div className="hero-platforms-logos">
                            ...
                            <div className="platform-logo" title="Gmail">
                                <svg viewBox="0 0 48 48" width="28" height="28">
                                    ...
                                    <path fill="#1e88e5" d="M3,16.2l3.714,1.638L13,23.7V40H6c-1.657,0-3-1.343-3-3V16.2z" />
