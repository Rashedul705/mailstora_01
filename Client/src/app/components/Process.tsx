...
export default function Process() {
    const steps = [
        { num: "01", title: "Share Idea & Needs", desc: "If you have a ready design, that's a plus! Otherwise, simply share your idea and needs, and I will handle the design for you." },
