...
const seedData = [
  {
    ...
    coverImage: "/images/email1.jpg", 
    cardBackground: "navy",
    desktopImages: ["/images/email1.jpg"],
    mobileImages: ["/images/email1.jpg"],
    angleViews: [],
